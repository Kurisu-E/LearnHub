...
- So [when it comes time to](http://127.0.0.1:5500/En/dict/when_it_comes_time_to.html#entry1.1-1) to pick up a location for their new Airbnb, a host needs to know where a property is likely to be [in demand](http://127.0.0.1:5500/En/dict/in_demand.html#entry1.1-1).
